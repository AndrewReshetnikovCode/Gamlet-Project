...
public class Compass : MonoBehaviour
{
    ...
    void Start () 
    {
        Greta = GameObject.Find("Greta");
            ...
            COMPASSTexture.GetComponent<Renderer>().material = COMPASSMtl;
            COMPASSTexture.GetComponent<Renderer>().material.color = new Color(1, 1, 1, 1);
