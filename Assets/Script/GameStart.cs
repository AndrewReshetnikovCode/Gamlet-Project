...
public class GameStart : MonoBehaviour {
	...
	void Start () {
        ...
        //moviePlane.GetComponent<Renderer>().material.mainTexture = moTexture;
        moviePlane.GetComponent<Renderer>().material.color = new Color(0, 0, 0, 0);
        moTexture.Play();
	}
	...
	void Update () 
    {
        ...
        moviePlane.GetComponent<Renderer>().material.color = new Color(TitleSmoothMove * 0.3f, TitleSmoothMove * 0.3f, TitleSmoothMove * 0.3f);
        if (isTitleFadeIn)
        {
